"""
Skill: Pick up a cube and place it at a target location. See PickCube-v1 in ManiSkill.
...
class Args:
    ...
    obs_mode: str = "state"
    # pd_ee_delta_pose: Move in 7D (NOT just position).
    ...
    # PPO — pnp is harder than pushing and reaching target loc, so we train longer
