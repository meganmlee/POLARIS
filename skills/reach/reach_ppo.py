...
class Args:
    ...
    num_steps: int = 100            # rollout horizon per iteration (env max_episode_steps=1000)
        ...
        with torch.no_grad():
            ...
            for t in reversed(range(args.num_steps)):
                if t == args.num_steps - 1:
                    nnd = 1.0 - next_done
                    # finite_horizon_gae: don't bootstrap past the rollout boundary;
                    # treat rollout end as episode end rather than bootstrapping V(s_T)
